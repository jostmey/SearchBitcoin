...
class VendorSubmissionsController extends Controller
{
	...
	{
		$model=new VendorSubmissions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['VendorSubmissions']))
			$model->attributes=$_GET['VendorSubmissions'];
	...
	{
		$model=VendorSubmissions::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='vendor-submissions-form')
		{
