...
<div class="collapseContainer">
    ...
    <div class="collapsingDiv" style="display: block;">
        ...
        <?php  echo $form->text('powerSlideWidth', "990", array('style' => 'width: 90px')). " px";?>
        </div>
        
        <div style="margin: 20px 0;">
        <label for="powerSlideHeight"><?php  echo t("Yeah, and what kinda height we talkin?"); ?></label>
        <?php  echo $form->text('powerSlideHeight', "456", array('style' => 'width: 90px')). " px";?>
        </div>
        ...
        <?php  echo $form->text('slideDelay', "5", array('style' => 'width: 90px')); ?>
        </div>
...
<div class="collapseContainer">
    ...
    <div class="collapsingDiv">
        <div style="margin: 20px 0;">
            ...
            <?php  echo $form->select('prevNextArrows', array('prevNextOff' => 'Hate Em', 'prevNextOn' => 'Love em'), 'prevNextOff', array('onChange' => 'updatePrevNextOptions();'));?>
            <script type="text/javascript">
...
<div class="collapseContainer">
    ...
    <div class="collapsingDiv">
        ...
        <div style="margin: 20px 0;">
            ...
            <?php  echo $form->select('paginationToggle', array('paginationOn' => 'Love em', 'paginationOff' => 'Hate Em'), 'paginationOff', array('onChange' => 'updatePaginationOptions();'));?>
            <script type="text/javascript">
        ...
        <div id="paginationOptionsHidden">
            <div style="margin: 20px 0;">
                ...
                <?php  echo $form->text('paginationOffsetY', "0", array('style' => 'width: 90px')). " px";?>
            </div>
